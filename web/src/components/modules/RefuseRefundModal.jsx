    ...
    render() {
        ...
        return (
            <div id="refuseRefundModal" className="modal modal-fixed-footer row">
                ...
                {/** Modal头部：Title */}
                <div className="modal-title center-align white-text">拒绝退款</div>
                        ...
                        <div className="col s12">
                            <div className="col input-field s12">
                                <div className="col s12 custom-label-field grey-text left-align">
                                    申请金额：
                                    {refuseRefundModalReducer.refundApplyInfo != null &&
                                    <span className="fz16 pink-font">{formatUtil.formatNumber(refuseRefundModalReducer.refundApplyInfo.apply_fee,2)}</span>} 元
                                </div>
                            </div>
                        </div>

                        <div className="col s12">
                            <Input s={12} label="拒绝原因" maxLength="200" value={refuseRefundModalReducer.refundRemark} onChange={this.changeRefuseReason}/>
                        </div>
                    </div>
                </div>
