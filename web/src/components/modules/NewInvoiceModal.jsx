    ...
    render() {
        ...
        return (
            <div id="newInvoiceModal" className="modal modal-fixed-footer row">
                ...
                {/** Modal主体 */}
                <div className="modal-content padding-bottom0 padding-top15 white grey-text text-darken-2">
                    <div className="row margin-bottom0">
                        ...
                        <Input s={6} label={<span><span className="must-input">*</span>开户银行</span>} maxLength="30" value={newInvoiceModalReducer.bank} onChange={this.changeBank}/>
                        <Input s={6} label={<span><span className="must-input">*</span>银行账号</span>} maxLength="30" value={newInvoiceModalReducer.bankNum} onChange={this.changeBankNum}/>
                        <Input s={12} label="单位地址" maxLength="100" value={newInvoiceModalReducer.companyAddress} onChange={this.changeCompanyAddress}/>
                        <Input s={12} label="备注" maxLength="200" className="margin-bottom0" value={newInvoiceModalReducer.remark} onChange={this.changeRemark}/>
                    </div>
                </div>
