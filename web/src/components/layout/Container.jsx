            ...
            <Router hashType={"hashbang"}>
                <div>
                    <ul id="slide-out" className="sidenav">
                        ...
                        <li className="no-padding"> <Link to="/panel"  className="collapsible-header"><i className="mdi mdi-cards-variant"></i>面板</Link></li>
                        <li><div class="divider"></div></li>

                        <li className="no-padding"> <Link to="/user" className="collapsible-header"><i className="mdi mdi-account-group"></i>用户</Link></li>
